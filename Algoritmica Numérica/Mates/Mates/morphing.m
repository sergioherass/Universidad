...
im1_def=warp_img(im1,P1,zona);
im2_def=warp_img(im2,P2,zona);
mezcla=0.5*im2_def;

mezcla=0.5*im1_def+0.5*im2_def;
subplot(1,1,1), image(mezcla)
mezcla=(1-0.7)*im1_def+0.7*im2_def; % Caso similar con 0.3
subplot(1,1,1), image(mezcla)
