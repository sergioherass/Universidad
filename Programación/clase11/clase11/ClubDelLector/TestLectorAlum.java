...
public class TestLectorAlum {
	...
	public static void main(String[] args) {
		...
		//volver a probar
		try {
			Libro libro1 = new Libro("El quijote", "Miguel de Cervantes", new Fecha("16/01/1605"));
			Libro libro2 = new Libro("El quijote 2ª edición", "Miguel de Cervantes", new Fecha("16/01/1625"));
